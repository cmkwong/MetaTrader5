# from mt5.executor import common as mt5common, mt5Model
# from mt5.loader import prices, files
...
#
#     # read extra loader
#     long_signal, short_signal, long_modified_q2d, short_modified_q2d = files.read_min_extra_info(file_options['extra_data_path'])
#
#     symbols_min_prices = prices._get_local_prices(file_options['data_path'], file_options['symbols'], file_options['data_time_difference_to_UTC'], file_options['timeframe'], '1001')
#
#     # make the extra loader in higher resolution
#     print("Processing: Resolution of the extra loader")
