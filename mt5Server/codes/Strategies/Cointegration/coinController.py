...
from mt5Server.codes.Mt5f.executor import CsvWriterHelper
...
from mt5Server.codes.Mt5f.loader import MT5PricesLoader
from mt5Server.codes.Views import plotView
import os
...
with CsvWriterHelper.CsvWriterHelper():
