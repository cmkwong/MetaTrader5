...
def _get_format_plot_data(df, text=None, equation=None):
    plt_data = {}
    plt_data['df'] = df
    plt_data['text'] = text
...
def get_coin_plt_datas(Prices, coefficient_vector, upper_th, lower_th, z_score_rolling_mean_window):
    """
    ...
    """
    # prepare
    coin_data = coinModel.get_coin_data(Prices.c, coefficient_vector, z_score_rolling_mean_window)
    ...
    equation = get_coin_equation_text(Prices.c.columns, coefficient_vector)
...
def get_coinNN_plt_datas(Prices, coefficient_vector, upper_th, lower_th, z_score_rolling_mean_window):
    pass
